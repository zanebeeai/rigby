...
``rigby_core.motion.compiler.compile_motion_program`` annotates its ``rig``
...
def _compiler_source_path() -> Path:
    from rigby_core.motion import compiler
...
def test_compiler_reads_only_the_declared_rig_members() -> None:
    ...
    assert not unexpected, (
        "rigby_core motion compiler now reads rig members this package does not "
