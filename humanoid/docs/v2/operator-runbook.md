...
This runbook operates the local-first MuJoCo service on Windows. Commands are run from `humanoid`. Never put production credentials in `.env`, console output, evidence files, or support bundles.
