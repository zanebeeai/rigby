...
from rigby_core.hashing import canonical_json, canonical_json_bytes, content_hash, hash_file, sha256_bytes
...
def main() -> int:
    ...
    descriptor_spec = {
        ...
        "dimensions": 256,
        "canonical_input": "rigby_core.hashing.canonical_json",
